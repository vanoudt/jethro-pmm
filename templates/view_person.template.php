                    ...
                    <tbody>
                        ...
                        ?>
                            <tr<?php echo $trclass; ?>>
                                ...
                                ?>
                                <td>
                                    <a data-method="post" class="link-collapse confirm-title" href="?view=_edit_group&action=remove_member&groupid=<?php echo $id; ?>&back_to=persons&personid=<?php echo $person->id; ?>" title="Remove <?php $person->printFieldValue('name'); ?> from <?php echo ents($details['name']); ?>">
